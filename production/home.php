            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="instancesms.php"><i class="fa fa-sms"></i> Instance SMS </a>
                    // <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-"></i> Google Sheets </a>
                    // <ul class="nav child_menu">
                  ...
                  <li><a href="spreadsheet.php"><i class="fas fa-file-spreadsheet"></i> Tables <span class="fa fa-chevron-down"></span></a>
                  //   <ul class="nav child_menu">
