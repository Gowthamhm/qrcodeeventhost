...
<head>
    ...
    <title>QR Code Scanned Info</title>
                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>QR Code Scanned Info Details</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <div class="row">
                                                ...
                                                <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        for ($j = 0; $j < count($qrcodeData); $j++) {
                                                            // echo $j;
                                                            $sql = "SELECT * FROM `qrscannedinfo` where id='" . $qrcodeData[$j] . "'";
                                                            // echo $sql;
                                                            $result = $conn->query($sql);
                                                            // echo $result->num_rows;
                                                            if ($result->num_rows > 0) {
                                                                while ($row = $result->fetch_assoc()) {
                                                                    ...
                                                                    echo $row['scannedby'];
                                                                    echo "</td> <td>";
                                                                    echo date('l dS \o\f F Y h:i:s A', $row['time']);
                                                                    echo "</td> <td>";
